...
$bodyHtml
  ...
  static const Map<String, Map<String, String>> _translations = {
    'en': {
      ...
      'spaces': 'Spaces',
      'about_desc': 'Marka is a professional-grade Markdown editor designed for industrial writing and focus. [v3.3.12-RC]',
      ...
      'desc_language': 'Controls the display language of the Marka IDE user interface.',
      'desc_theme': 'Specifies the color theme used in the workbench (Light / Dark Theme).',
      'desc_auto_save': 'Controls auto save of dirty files. Automatically saves content changes to disk.',
      'desc_font_family': 'Controls the font family used in text editing canvas.',
      'desc_font_size': 'Controls font size in pixels (8px - 32px range).',
      'desc_line_height': 'Controls the line height multiplier for text paragraphs.',
      'desc_word_wrap': 'Controls how lines should wrap. Enable soft wrap at viewport boundary.',
      'desc_line_numbers': 'Controls the display of vertical line numbers in line gutter.',
      'desc_auto_pairing': 'Controls whether the editor should automatically close quotes and brackets.',
      'desc_show_toolbar': 'Controls visibility of top editor formatting toolbar.',
      'desc_editor_padding': 'Horizontal padding offset around text editing canvas in pixels.',
      'desc_split_screen': 'Controls side-by-side Markdown live preview pane.',
      'desc_sync_scroll': 'Synchronize editor scroll position with live Markdown preview.',
      'about_version_desc': 'Currently installed core platform release version',
      'about_author_desc': 'Marka platform lead architect and developer',
      'about_license_desc': 'Open source software distribution license terms',
      'about_repo_desc': 'Official GitHub repository and bug tracker',
    },
    ...
    'zh': {
      ...
      'spaces': '个空格',
      'about_desc': 'Marka 是一款专注于高品质专注写作与极客排版的工业级 Markdown 编辑器。[v3.3.12-RC]',
      'about_version': '软件版本',
      ...
      'desc_language': '控制 Marka IDE 用户界面的显示语言。',
      'desc_theme': '指定工作台使用的颜色主题（浅色/深色主题）。',
      'desc_auto_save': '控制未保存文件的自动保存，自动将修改内容保存至磁盘。',
      'desc_font_family': '控制文本编辑画布中使用的字体系列。',
      'desc_font_size': '控制字号大小（8px - 32px 范围）。',
      'desc_line_height': '控制文本段落的行高倍率。',
      'desc_word_wrap': '控制换行模式，在视口边界启用自动软换行。',
      'desc_line_numbers': '控制编辑区域侧边行号栏的显示。',
      'desc_auto_pairing': '控制编辑器是否自动补全括号与引号。',
      'desc_show_toolbar': '控制编辑器顶部格式工具栏的显示状态。',
      'desc_editor_padding': '文本编辑画布左右两侧的内边距大小（像素）。',
      'desc_split_screen': '控制 Markdown 实时分屏预览面板。',
      'desc_sync_scroll': '同步编辑器与 Markdown 实时预览的滚动位置。',
      'about_version_desc': '当前已安装的平台核心引擎版本',
      'about_author_desc': 'Marka 架构与核心平台开发者',
      'about_license_desc': '开源软件分发与授权使用条款',
      'about_repo_desc': '官方 GitHub 源代码仓库与 Bug 跟踪',
    },
  };
