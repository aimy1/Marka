      ...
      case 2: // Appearance
        return Column(
          children: [
            ...
            _settingTile(p.t('show_line_numbers'), Icons.format_list_numbered_rounded, isDark, Switch(
              value: p.showLineNumbers,
              activeColor: accentColor,
              onChanged: (v) => p.toggleLineNumbers(),
            )),
            _settingTile(p.t('show_grid_lines'), Icons.grid_on_rounded, isDark, Switch(
              value: p.showGridLines,
              activeColor: accentColor,
              onChanged: (v) => p.toggleGridLines(),
            )),
            _settingTile(p.t('line_highlight'), Icons.border_horizontal_rounded, isDark, Switch(
      ...
      default:
        return Column(
          children: [
            ...
            _settingTile(p.t('about_version'), Icons.info_outline_rounded, isDark, Text('v3.3.8', style: GoogleFonts.inter(fontSize: 13, fontWeight: FontWeight.bold, color: isDark ? Colors.white70 : Colors.black87))),
