...
class EditorRowBackgroundPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    // Draw horizontal grid lines aligning perfectly with each line of text
    final double scrollOffset = scrollController.offset;
    int firstVisibleIndex = ((scrollOffset - topPadding) / lineHeight).floor();
    if (firstVisibleIndex < 0) firstVisibleIndex = 0;
    
    for (int i = firstVisibleIndex; ; i++) {
      final double y = topPadding + (i * lineHeight) - scrollOffset;
